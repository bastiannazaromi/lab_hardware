            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <?php echo form_open('dashboard/dosen/checkout'); ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="badge badge-warning edit_brg" data-toggle="modal"
                                            ...
                                            Edit</a>
                                        <a href="<?= base_url() ?>dashboard/dosen/hapus/<?= enkrip($hasil['id']); ?>"
...
<div class="modal fade" id="modalAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <form action="<?= base_url('dashboard/dosen/tambah'); ?>" method="post">
...
<div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="<?= base_url('dashboard/dosen/edit'); ?>" method="post">
            <div class="modal-content">
                <div class="modal-header">
...
$(document).ready(function() {
    ...
    $('#kategori').change(function() {
        ...
        $.ajax({
            url: "<?= base_url('dashboard/dosen/cari_barang'); ?>",
            type: 'post',
            dataType: 'json',
            data: dataJson,
