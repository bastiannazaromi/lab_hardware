                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="badge badge-warning edit_brg" data-toggle="modal"
                                            ...
                                            Edit</a>
                                        <a href="<?= base_url() ?>dosen/beranda/hapus/<?= $hasil['id']; ?>"
...
<div class="modal fade" id="modalAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <form action="<?= base_url('dosen/beranda/tambah'); ?>" method="post">
...
<div class="modal fade" id="modalEdit<?= $dt['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="<?= base_url('dosen/beranda/edit'); ?>" method="post">
            <div class="modal-content">
                <div class="modal-header">
...
$(document).ready(function() {
    ...
    $('#kategori').change(function() {
        ...
        $.ajax({
            url: "<?= base_url('dosen/beranda/cari_barang'); ?>",
            type: 'post',
            dataType: 'json',
            data: dataJson,
